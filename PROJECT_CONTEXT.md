...
│ │ ├── Layout.jsx # NEW: wraps Header + <Outlet /> + Footer (Footer pending 5.5.2)
│ │ ├── Footer.jsx # NOT YET CREATED — next subtask 5.5.2, currently breaks Layout import
...
5.5.1 — Built Layout.jsx (Header + <Outlet /> + Footer) and updated App.jsx to nest all three routes under it via a parent <Route element={<Layout />}>. Footer.jsx does not exist yet, so this currently breaks the dev server until 5.5.2 is completed.
Current subtask:
ID: 5.5.2
Title: Build Footer component
Goal: Create simple centered footer text with top border.
Files involved: src/components/Footer.jsx
Next subtask:
ID: 5.6.1
Title: Build MobileTabBar component
Goal: Create bottom tab bar with 4 tab buttons (Overview, Trends, Transactions, Goals), hidden above md breakpoint.
Files involved: src/components/MobileTabBar.jsx
...
src/components/Layout.jsx — NEW: renders Header, a flex-grow <main> with <Outlet />, and Footer (Footer import currently broken — pending 5.5.2)
...
src/hooks/ — still .gitkeep placeholder only
...
2026-07-05: Completed 5.5.1 — built Layout.jsx (Header + Outlet + Footer) and nested all routes under it in App.jsx. Footer.jsx not yet created — dev server currently broken until 5.5.2.
...
DateRangeContext's value is displayed and settable via Header, but nothing downstream reads it yet for actual filtering — lands in useFilteredTransactions (5.7.1) and useSummaryTotals (5.7.2).
...
ACTIVE BLOCKER: src/components/Layout.jsx imports ./Footer.jsx, which does not exist yet. The dev server will fail to compile until subtask 5.5.2 (Build Footer component) is completed — this is expected and is the very next subtask, not a bug to fix separately.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
